"""Test/demo fixture: deterministic in-memory semantic adapter.

This is a copy of the former ``MockSemanticAdapter`` moved out of the
runtime package so the test suite no longer depends on a mock that ships
as production code.
"""
